...
public class SendBadgeCampaignMessageEvent {
    @MessageEvent(messageId = EClientMessage.SendBadgeCampaignMessageEvent)
    public static void eventHandler(Session session, ClientMessage message) {
        // TODO: Implementation for org.azure.communication.messages.incoming.landing.SendBadgeCampaignMessageEvent
    }
}