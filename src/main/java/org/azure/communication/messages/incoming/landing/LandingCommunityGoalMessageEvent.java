...
public class LandingCommunityGoalMessageEvent {
    @MessageEvent(messageId = EClientMessage.LandingCommunityGoalMessageEvent)
    public static void eventHandler(Session session, ClientMessage message) {
        // TODO: Implementation for org.azure.communication.messages.incoming.landing.LandingCommunityGoalMessageEvent
    }
}