...
public class GetHotelViewHallOfFameMessageEvent {
    @MessageEvent(messageId = EClientMessage.GetHotelViewHallOfFameMessageEvent)
    public static void eventHandler(Session session, ClientMessage message) {
        // TODO: Implementation for org.azure.communication.messages.incoming.landing.GetHotelViewHallOfFameMessageEvent
    }
}