...
public class HotelViewCountdownMessageEvent {
    @MessageEvent(messageId = EClientMessage.HotelViewCountdownMessageEvent)
    public static void eventHandler(Session session, ClientMessage message) {
        // TODO: Implementation for org.azure.communication.messages.incoming.landing.HotelViewCountdownMessageEvent
    }
}