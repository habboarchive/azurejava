...
public class LandingRefreshRewardMessageEvent {
    @MessageEvent(messageId = EClientMessage.LandingRefreshRewardMessageEvent)
    public static void eventHandler(Session session, ClientMessage message) {
        // TODO: Implementation for org.azure.communication.messages.incoming.landing.LandingRefreshRewardMessageEvent
    }
}