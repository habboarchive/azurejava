...
public class LandingRefreshPromosMessageEvent {
    @MessageEvent(messageId = EClientMessage.LandingRefreshPromosMessageEvent)
    public static void eventHandler(Session session, ClientMessage message) {
        // TODO: Implementation for org.azure.communication.messages.incoming.landing.LandingRefreshPromosMessageEvent
    }
}